...
更新流程（按依赖顺序）:
    ...
    7. UPDATE_STRATEGY_TPO_3/TPO_TOP/TPO_NB/TPO_MA/TPO_VR  策略选股（Strategy/ 回测数据）
    8. UPDATE_TARGET_TPO_3/TPO_TOP/TPO_NB  策略实盘候选池（TARGET/ 候选股）
"""
...
from AICode.MarcoAPI.Update.SZ200Target import UPDATE_TARGET_TPO_3, UPDATE_TARGET_TPO_TOP, UPDATE_TARGET_TPO_NB
...
def UPDATE_ALL():
    ...
    steps = [
        ...
        ("UPDATE_STRATEGY_TPO_NB", UPDATE_STRATEGY_TPO_NB),
        ("UPDATE_STRATEGY_TPO_MA", UPDATE_STRATEGY_TPO_MA),
        ("UPDATE_STRATEGY_TPO_VR", UPDATE_STRATEGY_TPO_VR),
        ("UPDATE_TARGET_TPO_3", UPDATE_TARGET_TPO_3),
        ("UPDATE_TARGET_TPO_TOP", UPDATE_TARGET_TPO_TOP),
        ("UPDATE_TARGET_TPO_NB", UPDATE_TARGET_TPO_NB),
    ]
